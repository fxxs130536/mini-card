...
export default {
      ...
      paintingList: [
        {
          ...
          views: [
            ...
            {
              type: 'text',
              content: '广东省佛山市c时代广东省佛山市c时代广东省佛山市c时代广东省佛山市c时代',
              fontSize: 14,
              lineHeight: 22,
              height: 22,
              color: '#495060',
  ...
  methods: {
    ...
    async qrCodeFn () {
      ...
      // this.qrCodeImg = qrCode.url
      this.base64 = qrCode.baseImg
